                                        ...
                                        <div class="direct-chat-contacts">
                                            <ul class="contacts-list">
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/storage/images/user1-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/storage/images/user7-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/storage/images/user3-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/storage/images/user5-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/storage/images/user6-128x128.jpg" alt="User Avatar">
                                                ...
                                                <li>
                                                    <a href="#">
                                                        <img class="contacts-list-img"
                                                            src="/storage/images/user8-128x128.jpg" alt="User Avatar">
                                ...
                                <ul class="products-list product-list-in-card pl-2 pr-2">
                                    <li class="item">
                                        <div class="product-img">
                                            <img src="/storage/images/default-150x150.png" alt="Product Image"
                                                class="img-size-50">
                                        </div>
