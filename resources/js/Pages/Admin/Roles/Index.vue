                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <button class="btn btn-info text-uppercase" type="button" style="letter-spacing: 0.1em;" @click="openModel">Create</button>
                                </div>
                            </div>
                                        ...
                                        <tr v-for="(role, index) in roles" :key="index">
                                            ...
                                            <td>
                                                <div class="d-flex flex-column">
                                                    <span v-for="(permission, index) in role.permissions" :key="index">{{ permission.name }}</span>
                                                </div>
                                            </td>
                        ...
                        <div class="card card-primary">
                            <form>
                                <div class="card-body">
                                    ...
                                    <div class="invalid-feedback mb-3" :class="{ 'd-block' : form.errors.permissions }">
                                        {{ form.errors.permissions }}
                                    </div>
                                </div>
                                <div class="modal-footer justify-content-between">
                                    <button type="button" class="btn btn-danger text-uppercase" style="letter-spacing: 0.1em;" @click="closeModel">Cancel</button>
                                    <button type="submit" class="btn btn-info text-uppercase" style="letter-spacing: 0.1em;">Submit</button>
                                </div>
                            </form>
                        </div>
                    </div>
